...
async function migrateToVercelPostgres() {
  ...
  try {
    ...
    console.log('2. Test the API: node scripts/tests/test-vercel-deployment.js');
    ...
    console.error('3. Check that schema is created (run scripts/db/create-vercel-schema.js first)');
    process.exit(1);
  } finally {
