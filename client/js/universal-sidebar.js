    ...
    const UniversalSidebar = {
        ...
        menus: {
            student: [
                ...
                { icon: '🎪', text: 'Clubs', href: '/dashboard/student-clubs.html', page: 'clubs' },
                { icon: '🍽️', text: 'Hostel Menu', href: '/dashboard/student-hostel-menu.html', page: 'hostel' },
                { icon: '🚪', text: 'Logout', href: '#', page: 'logout' }
            ],
            teacher: [
                { icon: '🏠', text: 'Dashboard', href: '/dashboard/teacher.html', page: 'dashboard' },
                { icon: '📊', text: 'Mark Attendance', href: '/dashboard/teacher-attendance.html', page: 'attendance' },
                { icon: '📈', text: 'Upload Marks', href: '/dashboard/teacher-marks.html', page: 'marks' },
                { icon: '📝', text: 'Assignments', href: '/dashboard/teacher-assignments.html', page: 'assignments' },
                { icon: '📚', text: 'Study Material', href: '/dashboard/teacher-notes.html', page: 'notes' },
                { icon: '🎯', text: 'Question Bank', href: '/dashboard/teacher-question-bank.html', page: 'question-bank' },
                { icon: '📋', text: 'Rubric Creator', href: '/dashboard/teacher-rubric-creator.html', page: 'rubric' },
                { icon: '👥', text: 'My Students', href: '/dashboard/teacher-students.html', page: 'students' },
                { icon: '🚪', text: 'Logout', href: '#', page: 'logout' }
            ],
            admin: [
                { icon: '🏠', text: 'Dashboard', href: '/dashboard/admin.html', page: 'dashboard' },
                { icon: '✅', text: 'Approvals', href: '/dashboard/admin-approvals.html', page: 'approvals' },
                { icon: '👥', text: 'User Management', href: '/dashboard/admin-users.html', page: 'users' },
